...
;window.Modernizr = function(a, b, c) {
    ...
    function(a, b) {
        ...
        function r(a) {
            a || (a = b);
            var c = n(a);
            return s.shivCSS && !g && !c.hasCSS && (c.hasCSS = !!l(a, "article,aside,dialog,div,div,footer,header,hgroup,main,nav,div{display:block}mark{background:#FF0;color:#000}template{display:none}")),
            k || q(a, c),
            a
        }
